...
public interface GraphDatabaseService
{
    ...
    default long lazyFindNodes(final Label myLabel, final String key, final Object value) { throw new UnsupportedOperationException( "lazyFindNodes not overridden" ); }
    default long lazyFindNodesSpliced(final Label myLabel, final String key, final long operationNum, final String desiredProp) { throw new UnsupportedOperationException( "lazyFindNodes not overridden" ); }
    default void propagate() { throw new UnsupportedOperationException( "propagate not overridden" ); }
    default boolean propagateResults() {throw new UnsupportedOperationException( "propagateResults not overridden" );}
    default Node getResult(final Label myLabel, final String key, final Object value) { throw new UnsupportedOperationException( "getResult not overridden" ); }
    default Node getResult(final long operationNum) { throw new UnsupportedOperationException( "getResult not overridden" ); }
    default void readTraceFile(String file_name, int num_lines_to_read, Label myLabel) { throw new UnsupportedOperationException( "readTraceFile not overridden" ); }
    default long delete(long id) {throw new UnsupportedOperationException( "delete not overridden" );}
    default Node newCreateNode(Label ... labels) {throw new UnsupportedOperationException( "newCreateNode not overridden" );}
    default void beginPropagation() {throw new UnsupportedOperationException( "beginPropagation not overridden" ); }
    default void stopPropagation() {throw new UnsupportedOperationException( "stopPropagation not overridden" ); }

    default void parseLine(final Label myLabel, final String str) {throw new UnsupportedOperationException( "parseLine not overridden" );}
    default void parseLineEager(final Label myLabel, final String str, long eagerOpNum, long wait_time) {throw new UnsupportedOperationException( "parseLine not overridden" );}
    default void startTimer() { throw new UnsupportedOperationException( "startTimer not overridden" ); }
    default long stopTimer() { throw new UnsupportedOperationException( "stopTimer not overridden" ); }
    default void pauseTimer() { throw new UnsupportedOperationException( "pauseTimer not overridden" ); }
    default void setParams(final int NODES_TO_PROP) { throw new UnsupportedOperationException( "setParams not overridden" ); }
    default boolean hasOperationsRemaining() { throw new UnsupportedOperationException( "hasOperationsRemaining not overridden" ); }  
    default boolean reset(final Label myLabel) { throw new UnsupportedOperationException( "reset not overridden" ); }
    default ResourceIterator<Node> findNodesTimed(final Label myLabel, final String key, final Object value) {throw new UnsupportedOperationException( "reset not overridden" ); }
    public class OperationTimeWrapper {
	public ConcurrentHashMap<Long, Long> opTimes = new ConcurrentHashMap<Long, Long>();
	public ConcurrentHashMap<Long, Long> waitTimes =  new ConcurrentHashMap<Long, Long>();
	public void op(long opNum, long time) {
	    opTimes.put(opNum, time);
	}
	public void wait(long opNum, long time) {
	    waitTimes.put(opNum, time);
	}
	public void reset() {
	    opTimes.clear();
	    waitTimes.clear();	
    ...
    default OperationTimeWrapper getOpTimeWrapper() { throw new UnsupportedOperationException( "getOpTimeWrapper not implemented" ); }
    default void op(long opNum, long time) {throw new UnsupportedOperationException( "op not implemented" ); }
    default void wait(long opNum, long time) {throw new UnsupportedOperationException( "wait not implemented" );}
    default void setNumThreads(int num_threads) {throw new UnsupportedOperationException( "setNumThreads not implemented"); }
    default void setBatchingDebugOutput(boolean enable) { throw new UnsupportedOperationException( "setBatchingDebugOutput not implemented" ); }
    default void setOperationDebugOutput(boolean enable) { throw new UnsupportedOperationException( "setOperationDebugOutput not implemented" ); }
    default void setFusionDebugOutput(boolean enable) { throw new UnsupportedOperationException( "setFusionDebugOutput not implemeneted" ); }
    default long getNumberOfComparisons() {throw new UnsupportedOperationException( "getNumberOfComparisons not implemented" ); }
    default long getNumberOfTraversalSteps() {throw new UnsupportedOperationException( "getNumberOfTraversalSteps not implemented" ); }

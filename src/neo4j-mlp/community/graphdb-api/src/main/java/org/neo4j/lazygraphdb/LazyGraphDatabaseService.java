 ...
 */
public interface LazyGraphDatabaseService
{
    /**
     * Creates a new node.
     *
   ...
   default boolean fuse() { throw new UnsupportedOperationException( "fuse not overridden" ); }
